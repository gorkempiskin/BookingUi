  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      children: [
        Icon(
          Icons.star,
          color: rating >= 1 ? Colors.white : Colors.white70,
        ),
        SizedBox(
          width: 3,
        ),
        Icon(
          Icons.star,
          color: rating >= 2 ? Colors.white : Colors.white70,
        ),
        SizedBox(
          width: 3,
        ),
        Icon(
          Icons.star,
          color: rating >= 3 ? Colors.white : Colors.white70,
        ),
        SizedBox(
          width: 3,
        ),
        Icon(
          Icons.star,
          color: rating >= 4 ? Colors.white : Colors.white70,
        ),
        SizedBox(
        ...
        Icon(
          ...
          Icons.star,
          color: rating >= 5 ? Colors.white : Colors.white70,
